  ...
  return (
    <section id="about" style={s.section}>
      ...
      <div style={s.header}>
        ...
        <h2 style={s.heading}>
          Leading consultant in integrated<br />evidence generation.
        </h2>
      </div>
      ...
      <div style={s.body}>
        ...
        <div style={s.main}>
          {[
            ...
            'Through Princeton Biopartners and his research platform ThesisRx, Dillon advises life sciences organisations navigating three structural shifts reshaping healthcare: the rise of AI-powered longevity applications, the maturation of biomarker-driven precision medicine, and the emergence of direct-to-patient distribution models.',
...
const s = {
  ...
  heading: {
    ...
    fontWeight: 400, color: 'var(--green)', lineHeight: 1.2, textAlign: 'right',
  },
  body: {
